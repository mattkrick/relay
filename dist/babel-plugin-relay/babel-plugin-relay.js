	...
	module.exports = function BabelPluginRelay(context) {
	  ...
	  var visitor = {
	    TaggedTemplateExpression: function TaggedTemplateExpression(path, state) {
	      ...
	      if (ast) {
	        __webpack_require__(18)(t, path, state, ast);
	        return;
	      }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _possibleConstructorReturn3 = _interopRequireDefault(__webpack_require__(28));

	var _inherits3 = _interopRequireDefault(__webpack_require__(27));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function compileRelayQLTag(t, path, schemaProvider, quasi, documentName, propName, tagName, enableValidation, state) {
	  try {
	    ...
	    throw path.buildCodeFrameError(__webpack_require__(22)(error), Error);
	  }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getClassicTransformer(schemaProvider, options, fileOptions) {
	  ...
	  if (!classicTransformer) {
	    ...
	    classicTransformer = new (__webpack_require__(17))(schema, {
	...
	function getSchema(schemaProvider, fileOptions) {
	  ...
	  var introspection = typeof schemaReference === 'string' ? __webpack_require__(24)(schemaReference, fileOptions.sourceRoot) : schemaReference;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayQLTransformer = function () {
	  ...
	  node, options) {
	    ...
	    var Printer = __webpack_require__(16)(t, this.options);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function createAST(t, state, path, graphqlDefinition) {
	  ...
	  var modernNode = __webpack_require__(21)(t, graphqlDefinition, {
	  ...
	  if (isCompatMode) {
	    return __webpack_require__(20)(t, modernNode, __webpack_require__(19)(t, path, graphqlDefinition, state));
	  }
	  return modernNode;
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function createModernNode(t, graphqlDefinition, options) {
	  ...
	  var hash = __webpack_require__(29).createHash('md5').update(print(graphqlDefinition), 'utf8').digest('hex');
	...
	function getSchemaIntrospection(schemaPath, basePath) {
	  try {
	    ...
	    if (!__webpack_require__(15).existsSync(fullSchemaPath) && basePath) {
	      fullSchemaPath = __webpack_require__(30).join(basePath, schemaPath);
	    }
