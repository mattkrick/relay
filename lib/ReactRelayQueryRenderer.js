...
function (_React$Component) {
  ...
  _proto.componentWillUnmount = function componentWillUnmount() {
    ...
    var queryFetcher = this.state.queryFetcher;
    ...
    setTimeout(function () {
      ...
      if (environment && environment.unregisterQuery) {
        var request = getRequest(query);
        var queryKey = getRequestCacheKey(request.params, variables);
...
function fetchQueryAndComputeStateFromProps(props, queryFetcher, retryCallbacks, requestCacheKey) {
  ...
  if (query) {
    ...
    try {
      ...
      var callFetch = props.fetchPolicy !== 'store-or-network' || !storeSnapshot;
      var querySnapshot = callFetch ? queryFetcher.fetch({
