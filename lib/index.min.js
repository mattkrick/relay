...
!function (u, D) {
  ...
  var D = u(function (u) {
    ...
    e.inspectSource = function (u) {
      ...
      C && (B(t, "name") || a(t, "name", e)), u[e] !== t && (C && (B(t, r) || a(t, r, u[e] ? "" + u[e] : n.join(String(e)))), u === D ? u[e] = t : F ? u[e] ? u[e] = t : a(u, e, t) : (delete u[e], a(u, e, t)));
    ...
    for (F in i && (r = t), r) {
      C = ((n = !E && s && void 0 !== s[F]) ? s : r)[F], A = B && n ? d(C, D) : c && "function" == typeof C ? d(Function.call, C) : C, s && l(s, F, C, u & v.U), f[F] != C && a(f, F, A), c && p[F] != C && (p[F] = C);
    }
  };
  ...
  var W = {
    ...
    decimalPoint: function decimalPoint() {
      ...
      return G.isDigit(z) ? (T += q(), void (k = "decimalFraction")) : X("numeric", $ * Number(T));
    },
  ...
  return {
    parse: function parse(u, D) {
      ...
      return "function" == typeof D ? function u(D, e, t) {
        var r = D[e];
        if (null != r && "object" == typeof r) for (var F in r) {
          var n = u(r, F, t);
    ...
    stringify: function stringify(u, D, e) {
      var t,
          ...
          C = "",
          A = "";
      if (null == D || "object" != typeof D || Array.isArray(D) || (e = D.space, F = D.quote, D = D.replacer), "function" == typeof D) r = D;else if (Array.isArray(D)) {
        t = [];
