...
function getDirection(str, strongFallback) {
  ...
  !UnicodeBidiDirection.isStrong(strongFallback) ? process.env.NODE_ENV !== "production" ? !false ? process.env.NODE_ENV !== "production" ? invariant(false, 'Fallback direction must be a strong direction') : invariant(false) : void 0 : !false ? process.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) : void 0 : void 0;
