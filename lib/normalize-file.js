...
function _cloneDeep() {
  var data = _interopRequireDefault(require("./cloneDeep"));
...
var _missingPluginHelper = _interopRequireDefault(require("./missing-plugin-helper"));
