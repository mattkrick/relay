...
var _configApi = _interopRequireDefault(require("./config-api"));
...
function loadFullConfig(inputOpts) {
  ...
  try {
    ...
    var ignored = function recurseDescriptors(config, pass) {
      ...
      if (presets.length > 0) {
        passes.splice.apply(passes, [1, 0].concat((0, _toConsumableArray2["default"])(presets.map(function (o) {
          return o.pass;
        }).filter(function (p) {
          return p !== pass;
        }))));
      ...
      if (plugins.length > 0) {
        pass.unshift.apply(pass, (0, _toConsumableArray2["default"])(plugins));
      }
    }({
