...
function () {
  ...
  _proto.resolveKey = function resolveKey(key, value) {
    ...
    !!entry.isSettled() ? process.env.NODE_ENV !== "production" ? !false ? process.env.NODE_ENV !== "production" ? invariant(false, 'PromiseMap: Already settled `%s`.', key) : invariant(false) : void 0 : !false ? process.env.NODE_ENV !== "production" ? invariant(false) : invariant(false) : void 0 : void 0;
    entry.resolve(value);
  };
