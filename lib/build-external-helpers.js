...
function helpers() {
  var data = _interopRequireWildcard(require("./helpers"));
...
function _template() {
  var data = _interopRequireDefault(require("./template"));
...
function buildHelpers(body, namespace, whitelist) {
  ...
  helpers().list.forEach(function (name) {
    ...
    body.push.apply(body, (0, _toConsumableArray2["default"])(nodes));
  });
  return refs;
}
