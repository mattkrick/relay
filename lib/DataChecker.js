  ...
  _proto._checkMatch = function _checkMatch(field, dataID) {
    ...
    if (linkedID === undefined) {
      ...
      if (match != null) {
        ...
        !(operationLoader !== null) ? process.env.NODE_ENV !== "production" ? invariant(false, 'DataChecker: Expected an operationLoader to be configured when using `@match`.') : invariant(false) : void 0;

        var operationReference = this._mutator.getValue(linkedID, MATCH_FRAGMENT_KEY);
