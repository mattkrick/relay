...
function mergeChain(target, source) {
  ...
  (_target$options = target.options).push.apply(_target$options, (0, _toConsumableArray2["default"])(source.options));

  (_target$plugins = target.plugins).push.apply(_target$plugins, (0, _toConsumableArray2["default"])(source.plugins));

  (_target$presets = target.presets).push.apply(_target$presets, (0, _toConsumableArray2["default"])(source.presets));
...
function mergeChainOpts(target, _ref8) {
  ...
  (_target$plugins2 = target.plugins).push.apply(_target$plugins2, (0, _toConsumableArray2["default"])(plugins()));

  (_target$presets2 = target.presets).push.apply(_target$presets2, (0, _toConsumableArray2["default"])(presets()));
