    ...
    for (var i = 0; i < node.selections.length; i++) {
      ...
      switch (selection.kind) {
        ...
        case CONNECTION_FIELD:
          !false ? process.env.NODE_ENV !== "production" ? invariant(false, 'RelayResponseNormalizer(): Connection fields are not supported yet.') : invariant(false) : void 0; // $FlowExpectedError - we need the break; for OSS linter
