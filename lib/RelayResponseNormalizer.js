...
var _require2 = require("./RelayStoreUtils"),
    ...
    MATCH_FRAGMENT_KEY = _require2.MATCH_FRAGMENT_KEY,
...
function () {
  ...
  _proto._normalizeMatchField = function _normalizeMatchField(parent, field, record, data) {
    !(typeof data === 'object' && data) ? process.env.NODE_ENV !== "production" ? invariant(false, 'writeField(): Expected data for field `%s` to be an object.', field.name) : invariant(false) : void 0;
    ...
    var operationReference = fieldValue[MATCH_FRAGMENT_KEY];
