...
function _templateObject4() {
  var data = (0, _taggedTemplateLiteral2["default"])(["", "(this)"]);
...
function _templateObject() {
  var data = (0, _taggedTemplateLiteral2["default"])(["return ", ""]);
...
function _helperReplaceSupers() {
  var data = _interopRequireDefault(require("./helper-replace-supers"));
...
function _helperFunctionName() {
  var data = _interopRequireDefault(require("./helper-function-name"));
