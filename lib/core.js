...
(0, _utils["default"])("BinaryExpression", {
  ...
  fields: {
    operator: {
      validate: (0, _utils.assertOneOf).apply(void 0, (0, _toConsumableArray2["default"])(_constants.BINARY_OPERATORS))
    },
    left: {
      validate: (0, _utils.assertNodeType)("Expression")
    },
...
(0, _utils["default"])("LogicalExpression", {
  ...
  fields: {
    operator: {
      validate: (0, _utils.assertOneOf).apply(void 0, (0, _toConsumableArray2["default"])(_constants.LOGICAL_OPERATORS))
    },
    left: {
      validate: (0, _utils.assertNodeType)("Expression")
    },
...
(0, _utils["default"])("UnaryExpression", {
  ...
  fields: {
    ...
    operator: {
      validate: (0, _utils.assertOneOf).apply(void 0, (0, _toConsumableArray2["default"])(_constants.UNARY_OPERATORS))
    }
  },
  visitor: ["argument"],
...
(0, _utils["default"])("UpdateExpression", {
  ...
  fields: {
    ...
    operator: {
      validate: (0, _utils.assertOneOf).apply(void 0, (0, _toConsumableArray2["default"])(_constants.UPDATE_OPERATORS))
    }
  },
  visitor: ["argument"],
  aliases: ["Expression"]
