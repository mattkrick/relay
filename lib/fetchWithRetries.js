    ...
    function sendTimedRequest() {
      ...
      var requestTimeout = setTimeout(function () {
        ...
        if (shouldRetry(requestsAttempted)) {
          process.env.NODE_ENV !== "production" ? process.env.NODE_ENV !== "production" ? warning(false, 'fetchWithRetries: HTTP timeout, retrying.') : void 0 : void 0;
          retryRequest();
        } else {
      ...
      request.then(function (response) {
        ...
        if (isRequestAlive) {
          ...
          if (response.status >= 200 && response.status < 300) {
            ...
            process.env.NODE_ENV !== "production" ? process.env.NODE_ENV !== "production" ? warning(false, 'fetchWithRetries: HTTP error, retrying.') : void 0 : void 0, retryRequest();
          } else {
